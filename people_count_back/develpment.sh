pip install -r requirements.txt -t /home/ec2-user/environment/people-counter-for-events/people_count_back/lambda
...
cd /home/ec2-user/environment/people-counter-for-events/people_count_back/lambda
...
aws cloudformation create-stack \
  ...
  --template-body file:///home/ec2-user/environment/people-counter-for-events/people_count_back/samples.json \
